...
local function GetURL(scripturl)
	if shared.VapeDeveloper then
		...
		return game:HttpGet("https://raw.githubusercontent.com/yesir38/vapev4/main/"..scripturl, true)
	end
end
...
local function checkpublicrepo(id)
	local req = requestfunc({
		Url = "https://github.com/yesir38/vapev4/main/CustomModules"..id..".vape",
		Method = "GET"
	})
...
local function checkassetversion()
	local req = requestfunc({
		Url = "https://raw.githubusercontent.com/yesir38/vapev4/main/assetsversion.dat",
		Method = "GET"
	})
	if req.StatusCode == 200 then
		return req.Body
...
local function getcustomassetfunc(path)
	if not isfile(path) then
		...
		local req = requestfunc({
			Url = "https://github.com/yesir38/vapev4/main"..path:gsub("vape/assets", "assets"),
			Method = "GET"
		})
...
OnlineProfilesButton.MouseButton1Click:connect(function()
	...
	if profilesloaded == false then
		...
		local success, result = pcall(function()
			return game:GetService("HttpService"):JSONDecode((shared.VapeDeveloper and readfile("vape/OnlineProfiles.vapeonline") or game:HttpGet("https://raw.githubusercontent.com/yesir38/vapev4/main/OnlineProfiles/BlatantBedWars.vapeprofile", true)))
		end)
		...
		for i2,v2 in pairs(onlineprofiles) do
			if v2["ProfileGame"] == game.PlaceId then
				...
				profiledownload.MouseButton1Click:connect(function()
					writefile("vape/Profiles/"..v2["ProfileName"]..tostring(game.PlaceId)..".vapeprofile", (shared.VapeDeveloper and readfile("vape/OnlineProfiles/"..v2["OnlineProfileName"]) or game:HttpGet("https://raw.githubusercontent.com/yesir38/vapev4/main/OnlineProfiles/"..v2["OnlineProfileName"], true)))
...
local teleportfunc = game:GetService("Players").LocalPlayer.OnTeleport:Connect(function(State)
    if State == Enum.TeleportState.Started then
        ...
        queueteleport('shared.VapeSwitchServers = true wait(1) if shared.VapeDeveloper then loadstring(readfile("vape/NewMainScript.lua"))() else loadstring(game:HttpGet("https://raw.githubusercontent.com/yesir38/vapev4/main/NewMainScript.lua", true))() end')
    end
end)
